...
BEGIN
	DECLARE @ID VARCHAR(5)
	IF (SELECT COUNT(SOLO) FROM LOVACCINE) = 0
		SET @ID = '0'
	ELSE
		SELECT @ID = MAX(RIGHT(SOLO, 3)) FROM LOVACCINE
		SELECT @ID = CASE
...
(
   MAVACCINE            char(5)                        PRIMARY KEY CONSTRAINT IDVC DEFAULT DBO.AUTO_IDVC(),
...
INSERT INTO VACCINE
VALUES
(DBO.AUTO_IDVC(),N'OPV',N'Trẻ có sự suy giảm miễn dịch.
Trong trường hợp trẻ bị tiêu chảy,
vẫn cho uống nhưng phải uống nhắc
lại 1 liều sau khi khỏi bệnh.',N'Sốt, quấy khóc sau khi uống.',N'Vaccin phải cho uống. Liều mỗi 
lần được ghi trên nhãn: 0,1 – 0,5 ml. ở Việt Nam mỗi liều thường dùng 2 giọt (0,1 ml); uống vào lúc mới đẻ và vào lúc 2 tháng tuổi,
 3 tháng tuổi, 4 tháng tuổi. Lịch cho uống có thể thay đổi, nhưng khoảng cách giữa 2 lần ít nhất phải 30 ngày.
  Miễn dịch tăng cường được tiến hành cho trẻ em dưới 5 tuổi. Uống 2 lần, mỗi lần 2 giọt, 
  cách nhau 1 tháng trong các chiến dịch tiêm chủng mở rộng quốc gia.',N'0.1  ml',N'',N'Việt Nam',N'Trẻ em 2,3,4 tháng tuổi'),
(DBO.AUTO_IDVC(),N'IPV',N'Có bệnh trung bình hoặc nặng có hoặc không có sốt
(tiêm vắc xin được trì hoãn lại cho đến khi khỏi bệnh).
Phản ứng dị ứng trầm trọng (ví dụ, chứng quá mẫn) 
sau khi chủng ngừa trước đó hoặc cho một thành phần
vắc xin.',N'Cảm giác rát bỏng hoặc đau nhói tại vùng tiêm.
Ít gặp: sốt (từ 38oC trở lên, trên da có vùng ban
đỏ nhưng thường nhẹ.
Hiếm gặp: Phản ứng nhẹ tại chỗ, như ban đỏ, chai
hoặc căng cứng, đau họng, khó chịu, sởi không điển
hình, ngất, dễ bị kích thích. Viêm tuyến mang tai, buồn
nôn, nôn và tiêu chảy.
Các phản ứng quá mẫn trên da như nổi mày đay, co thắt
khí phế quản có thể xảy ra ngay cả ở những
người không có tiền sử dị ứng.
Đau cơ, khớp: thường thoáng qua và không bị mạn tính.
Hay xảy ra ở phụ nữ ở lứa tuổi trưởng thành.',N'Tiêm bắp hoặc dưới da.',N'0.5 mL',N'',N'Việt Nam',N'Trẻ 5 tháng tuổi'),
(DBO.AUTO_IDVC(),N'MMR II',N'Đang có bệnh lý sốt hoặc viêm đường hô hấp.',N'Cảm giác rát bỏng hoặc đau nhói tại vùng tiêm.
Ít gặp: sốt (từ 38oC trở lên, trên da có vùng ban
đỏ nhưng thường nhẹ.
Hiếm gặp: Phản ứng nhẹ tại chỗ, như ban đỏ, chai
hoặc căng cứng, đau họng, khó chịu, sởi không điển
...
người không có tiền sử dị ứng.
Đau cơ, khớp: thường thoáng qua và không bị mạn tính.
Hay xảy ra ở phụ nữ ở lứa tuổi trưởng thành.',N'Tiêm dưới da, không được tiêm tĩnh mạch.',N'0.5 ml',N'',N'Việt Nam',N'Chỉ định để tạo miễn dịch phòng 3 bệnh: sởi, quai bị, rubella cho trẻ từ 12 tháng tuổi trở lên.'),
(DBO.AUTO_IDVC(),N'DPT',N'Nhiễm trùng cấp tính, sốt chưa rõ nguyên nhân.
...
Những phản ứng nghiêm trọng hơn như: co giật và giảm trương lực cơ.',N'Tiêm bắp sâu ở mặt trước bắp đùi (có thể làm trẻ tiêm
mũi DPT bị đau chân) hoặc cơ delta của cánh tay',N'0.5 ml',N'',N'Việt Nam',N'Trẻ từ 2 tháng tuổi trở lên'),
(DBO.AUTO_IDVC(),N'Jevax',N'Người nhạy cảm với bất kỳ thành phần nào trong vắc xin.
Người bị bệnh tim, gan, thận.
Mệt mỏi, sốt cao hoặc nhiễm trùng tiến triển.',N'Thường gặp là sưng, đau và nổi ban đỏ tại nơi tiêm. Những phản
 ứng này thường sẽ tự hết sau 1-2 ngày.
Phản ứng toàn thân thường gặp như sốt, đau đầu, buồn nôn,
chóng mặt có thể xảy ra với một số người',N'Tiêm dưới da',N'0.5 ml',N'',N'Việt Nam',N'Chỉ định để phòng viêm não Nhật bản cho mọi
đối tượng và cho trẻ em từ 12 tháng tuổi trở lên'),
(DBO.AUTO_IDVC(),N'MORCVA',N'Không dùng vắc xin mORCVAX cho trẻ đã quá mẫn cảm ở
...
Hiếm gặp: Đau đầu, đau bụng, tiêu chảy, sốt, tuy nhiên những triệu chứng này
sẽ tự khỏi mà không cần điều trị.',N'Chỉ dùng đường uống',N'1,5ml/liều',N'',N'Việt Nam',N'Chỉ định để phòng bệnh tả cho trẻ em trên 2 tuổi
và người lớn sống trong vùng dịch tả lưu hành.'),
(DBO.AUTO_IDVC(),N'TyPhoid',N'Không sử dụng Typhoid Vi cho trường hợp có tiền sử dị ứng với một trong các thành phần của vắc xin.',N'Phản ứng thường nhẹ, nhanh chóng biến mất. Khi tiêm vắc xin, tại chỗ tiêm có thể sưng đỏ. Có triệu chứng sốt nhẹ và sẽ hết sau 24h kể từ khi tiêm vắc xin.
Hiếm gặp phản ứng phản vệ.',N'Thường gặp: Sau khi uống vắc xin có thể có cảm giác buồn nôn hoặc nôn ói…
Hiếm gặp: Đau đầu, đau bụng, tiêu chảy, sốt, tuy nhiên những triệu chứng này
sẽ tự khỏi mà không cần điều trị.',N'Được chỉ định tiêm dưới da hoặc tiêm bắp',N'0.5 ml',N'Việt Nam',N'Tạo miễn dịch chủ động phòng bệnh thương hàn
...
(DBO.AUTO_IDVC(),N'VAT',N'Không tiêm cho người dị ứng, quá mẫn với bất kỳ thành phần nào của vắc xin.
...
Phải thông báo ngay cho bác sĩ những tác dụng không mong muốn gặp phải sau khi tiêm vắc xin.',N'VAT được chỉ định tiêm bắp sâu, 
Không tiêm tĩnh mạch trong bất cứ trường hợp nào.
Lắc tan đều trước khi tiêm.',N'liều tiêm 0,5ml',N'',N'Việt Nam',N'Tạo miễn dịch chủ động phòng bệnh uốn ván cho người lớn và trẻ em. Đặc biệt là các đối tượng có nguy cơ cao như:
Phụ nữ có thai.
...
(DBO.AUTO_IDVC(),N'VARIVAX',N'Mẫn cảm với bất kỳ thành phần nào của vắc xin, bao gồm cả: gelatin, neomycin.',N'Phản ứng tại chỗ tiêm: sưng, đau, khối tụ máu…
Có thể sốt cao.
...
(DBO.AUTO_IDVC(),N'TWINRIX',N'Người nhạy cảm với bất kỳ thành phần nào trong vắc xin hoặc có biểu hiện quá mẫn với vắc xin phòng viêm gan B và viêm gan A đơn lẻ.'
...
VALUES
(DBO.AUTO_IDLV(),20,20,'20/11/2022','VC001',0,'NHIEU LIEU')

INSERT INTO KEHOACHTIEM
VALUES
(DBO.AUTO_IDKHT(),'24/10/2021',2,'26/10/2021','NV001')

INSERT INTO PHIEUXUAT
VALUES
(DBO.AUTO_IDPX(),'21/11/2020','NONE','NV001','KHT001')
...
VALUES
(DBO.AUTO_IDPN(),'NV001','NCC001','20/11/2020','NONE')

INSERT INTO CHITIETPHIEUNHAP
VALUES
('PN001','LV001','LOVACCINE',20,10,'0','3','0.5 ml')
